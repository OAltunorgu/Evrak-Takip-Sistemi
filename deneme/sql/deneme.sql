...
--
-- Anamakine: localhost
-- Üretim Zamanı: 01 Tem 2020, 18:31:27
...
(0, 'dimg/29327DAU-ortalanmis-1-satir.png', 'DAÜ EVRAK TAKİP SİSTEMİ', 'DAÜ EVRAK TAKİP SİSTEMİ PROJESİ', 'evrak, daü', 'DAÜ EVRAK TAKİP SİSTEMİ', '+90 392 630 1484', '', '+90 392 365 0711', 'cmpe.info@emu.edu.tr', 'MAĞUSA', 'MAĞUSA', 'MAĞUSA', '7 * 24 ONLİNE', '', 'ayar_analystic', '1f42c312-9471-46ea-bfb0-662b876f3992', 'facebook.com', 'twitter.com/EMUOFFICIAL', 'www.google.com', 'www.youtube.com', 'mail.alanadiniz.com', '', 'password', '587', '1');
...
(43, 'Oğulcan', 'Altunörgü', 'ogulcan.altunorgu@gmail.com', '15000075', '2019-2020', 'BLGM-344', 'Güz', '05338557345', '2020-07-01 07:07:05', '3', 0);
...
(5, '2020-07-01 07:02:04', 'Admin', 'DENEME12', 1);
...
(1381, 'Kayıt Dondurma', 'dimg/evrak/27027kayitdondurma (1).pdf', '2020-07-01 03:47:31', 3, 15000075, '3'),
...
(1384, 'Dersten Çekilme', 'dimg/evrak/28775Dersten Çekilme Talebi (23).pdf', '2020-07-01 10:07:19', 2, 15000075, '3');
...
(2, '2020-03-29 00:07:55', '', 'ogulcan@gmail.com', '05338557345', 'e10adc3949ba59abbe56e057f20f883e', 'Öğrenci Oğulcan', 'Abaras Ap. Daire:3', 'İstanbul', 'Kadıköy', '0', 0, 1, '1', 1, 15000075, '::1'),
...
--
ALTER TABLE `evraklar`
  MODIFY `evrak_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1385;
